...
function SuppliersPageContent({
  ...
  const [loading, setLoading] = useState(initialSuppliers.length === 0)
  ...
  // Initial load — skip refetch when the server already provided the first page
  useEffect(() => {
    if (initialSuppliers.length > 0 && !industryFromUrl) return
        ...
        <div className="w-full grid grid-cols-1 lg:[grid-template-columns:300px_minmax(0,1fr)_360px] gap-6 lg:gap-8">
          ...
          <main className="space-y-4 md:space-y-6">
            ...
            <div className="relative w-full h-[96px] sm:h-[140px] md:h-[160px] rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center px-4">
                <h1 className="text-white text-[24px] font-bold text-center">
                  Find CNC, Tooling &amp; Manufacturing Suppliers
                </h1>
              </div>
            </div>
            ...
            <div className="text-[12px] text-gray-600">
              <a href="/" className="underline hover:text-gray-800">Home</a>
